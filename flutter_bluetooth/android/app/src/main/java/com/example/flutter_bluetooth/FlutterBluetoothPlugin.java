...
public class FlutterBluetoothPlugin implements FlutterPlugin, ActivityAware {
    ...
    private static final String PLUGIN_NAMESPACE = "flutter_bluetooth";
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (BluetoothDevice.ACTION_PAIRING_REQUEST.equals(intent.getAction())) {
                    ...
                    switch (pairingVariant) {
                        ...
                        case 3: //case BluetoothDevice.PAIRING_VARIANT_CONSENT:
                        ...
                        case 4: //case BluetoothDevice.PAIRING_VARIANT_DISPLAY_PASSKEY:
                        ...
                        case 5: //case BluetoothDevice.PAIRING_VARIANT_DISPLAY_PIN:
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action) {
                    case BluetoothDevice.ACTION_FOUND:
                        ...
                        //discoveryResult.put("class", deviceClass);
...
//        if (true) throw new RuntimeException("FlutterBluetoothSerial Attached to activity");
    ...
    private class FlutterBluetoothSerialMethodCallHandler implements MethodChannel.MethodCallHandler {
        ...
        public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
            ...
            switch (call.method) {
                ...
                case "pairingRequestHandlingEnable":
                    if (FlutterBluetoothPlugin.this.isPairingRequestHandlerSet) {
                    ...
                    FlutterBluetoothPlugin.this.isPairingRequestHandlerSet = true;
                ...
                case "pairingRequestHandlingDisable":
                    FlutterBluetoothPlugin.this.isPairingRequestHandlerSet = false;
                    try {
