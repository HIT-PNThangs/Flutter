...
import 'bluetooth_bond_state.dart';
import 'bluetooth_connection.dart';
import 'bluetooth_device.dart';
import 'bluetooth_discovery_result.dart';
import 'bluetooth_pairing_request.dart';
import 'bluetooth_state.dart';

class FlutterBluetooth {
  // Plugin
  static const String namespace = 'flutter_bluetooth';

  static final FlutterBluetooth _instance = FlutterBluetooth._();

  static FlutterBluetooth get instance => _instance;

  static MethodChannel get methodChannel => _methodChannel;

  static const MethodChannel _methodChannel = MethodChannel('$namespace/methods');
  ...
  Stream<BluetoothState> onStateChanged() =>
      _stateChannel.receiveBroadcastStream().map((data) => BluetoothState.fromUnderlyingValue(data));
  ...
  void setPairingRequestHandler(Future<dynamic> Function(BluetoothPairingRequest request)? handler) {
    if (handler == null) {
  ...
  Future<bool> get isConnected async => Future.value(_defaultConnection == null ? false : _defaultConnection!.isConnected);
