class BluetoothBondState {
  ...
  const BluetoothBondState.fromString(String string)
      : underlyingValue = (string == 'none'
        ...
        stringValue = ((string == 'none' || string == 'bonding' || string == 'bonded' //
                )
                ? string
  ...
  const BluetoothBondState.fromUnderlyingValue(int value)
      : underlyingValue = ((value >= 10 && value <= 12) ? value : 0 // Unknown, if not found valid
            ),
  ...
  operator ==(Object other) {
    return other is BluetoothBondState && other.underlyingValue == underlyingValue;
  }
