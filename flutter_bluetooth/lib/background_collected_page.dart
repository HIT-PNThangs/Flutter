...
class BackgroundCollectedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime beginningArgumentsStep = DateTime(beginningArguments.year, beginningArguments.month, beginningArguments.day);
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            (task.inProgress
                ...
                : IconButton(icon: const Icon(Icons.play_arrow), onPressed: task.reasume)),
          ],
        ),
        body: ListView(
          children: <Widget>[
            ...
            LineChart(
              ...
              seriesLinesStyles: const [
                PaintStyle(style: PaintingStyle.stroke, strokeWidth: 1.7, color: Colors.indigoAccent),
                PaintStyle(style: PaintingStyle.stroke, strokeWidth: 1.7, color: Colors.redAccent),
              ],
            ),
            const Divider(),
            const ListTile(
            ...
            LineChart(
              ...
              seriesLinesStyles: const [
                PaintStyle(style: PaintingStyle.stroke, strokeWidth: 1.7, color: Colors.greenAccent),
              ],
            ),
          ],
        ));
