...
class _DeviceWithAvailability {
  ...
  _DeviceWithAvailability(this.device, this.availability, [rssi]);
}
...
class _SelectBondedDevicePage extends State<SelectBondedDevicePage> {
  ...
  void initState() {
    ...
    FlutterBluetooth.instance.getBondedDevices().then((List<BluetoothDevice> bondedDevices) {
      setState(() {
  ...
  void _startDiscovery() {
    _discoveryStreamSubscription = FlutterBluetooth.instance.startDiscovery().listen((r) {
      setState(() {
