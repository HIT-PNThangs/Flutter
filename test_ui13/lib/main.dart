...
import 'src/bottom_sheets/bar_bottom_sheet.dart';
import 'src/bottom_sheets/cupertino_bottom_sheet.dart';
import 'src/bottom_sheets/material_bottom_sheet.dart';
import 'src/material_with_modal_page_route.dart';
import 'src/web_frame/flutter_web_frame.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      builder: (context, Widget? child) => FlutterWebFrame(
