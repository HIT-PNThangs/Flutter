...
import 'device_promo/promo.dart';
import 'device_promo/starter_app.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationController = AnimationController(vsync: this, duration: Duration(seconds: totalSecs));
    ...
    audioPlayer.setUrl(audioUrl).then((value) => setState(() => loading = false));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Expanded(
              ...
              child: SliderTheme(
                ...
                child: Slider(
                    ...
                    min: 0.0,
                    max: 1,
                    onChanged: (double value) => {animationController.value = value},
      ...
      body: RawKeyboardListener(
          ...
          focusNode: FocusNode(),
          onKey: (event) {
            if (event.physicalKey == PhysicalKeyboardKey.space && event is RawKeyDownEvent) updateAnimation();
          },
          child: Stack(
            children: [
              Center(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            final seconds = animationController.value * totalSecs;
                            return Stack(
                              fit: StackFit.expand,
                              children: [
                                if (seconds > 20.4 && seconds < 23.0) personalProjectText(),
              ...
              if (flutterPageIsVisible) const StarterApp(),
              AnimatedBuilder(
                  ...
                  return Align(
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        child: const Text('Press Play Button or Spacebar'),
                      ),
                    ),
                  );
                },
  ...
  void seekToSecond(double progress) async {
    ...
    await audioPlayer.seek(Duration(milliseconds: (progress * totalSecs * 1000).toInt()));
          ...
          Opacity(
            ...
            child: SizedBox(
                ...
                child: Text(
                  ...
                  style: TextStyle(height: 1.8, color: Colors.white.withOpacity(0.8), fontSize: 24),
                )),
          ),
        ],
      ),
...
class AnimatedIllustration extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ZIllustration(
      zoom: 2,
      children: [
        if (seconds > 20.0 && seconds < 23.0) SceneSide(style: DeviceStyles.white),
        if (seconds < 1.80)
          IPhonePromo(progress: fadeInAnimation.value, style: DeviceStyles.white)
        else if (seconds < 3.0)
              ...
              child: Builder(
                builder: (context) => Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      bottom: unlockPhone.value * MediaQuery.of(context).size.height,
                      width: MediaQuery.of(context).size.width,
                      height: MediaQuery.of(context).size.height,
                      child: Image.asset('assets/lock_screen.png'),
                    ),
          ...
          ZPositioned(
            translate: const ZVector.only(x: -150),
            child: IPhonePromoFlick(
              progress: fadeInAnimation.value,
              style: DeviceStyles.red,
            ),
          ...
          ZGroup(
            ...
            children: [
              if (seconds > 18.0)
                ZPositioned(
                  translate: const ZVector.only(x: -180),
                  child: IPhonePromoFlick(
                    progress: fadeInAnimation.value,
                    style: DeviceStyles.red,
