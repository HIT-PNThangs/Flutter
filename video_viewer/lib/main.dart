...
import 'src/domain/bloc/controller.dart';
import 'src/domain/entities/ads.dart';
import 'src/domain/entities/settings_menu_item.dart';
import 'src/domain/entities/styles/bar.dart';
import 'src/domain/entities/styles/chat.dart';
import 'src/domain/entities/styles/play_and_pause.dart';
import 'src/domain/entities/styles/progress_bar.dart';
import 'src/domain/entities/styles/settings_menu.dart';
import 'src/domain/entities/styles/video_viewer.dart';
import 'src/domain/entities/video_source.dart';
import 'src/video_viewer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        cardColor: const Color(0xFFfbfafe),
        primaryColor: const Color(0xFFd81e27),
        shadowColor: const Color(0xFF324754).withOpacity(0.24),
        textTheme: TextTheme(
...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Widget> children = [
      ...
      const Headline6("Series"),
      const SizedBox(height: kPadding),
      const MovieCardSlider(kSeriesData),
      const SizedBox(height: kSectionPadding),
      const Headline6("Movies"),
      const SizedBox(height: kPadding),
      const MovieCardSlider(kMoviesData),
    ]
          ...
          widget.movie.title: VideoSource(
            ...
            ads: [
              VideoViewerAd(
                ...
                child: Container(
                  color: Colors.black,
                  child: const Center(child: Headline4("AD ZERO")),
                ),
              ...
              VideoViewerAd(
                ...
                child: Container(
                  color: Colors.black,
                  child: const Center(child: Headline4("AD HALF")),
                ),
                durationToSkip: const Duration(seconds: 4),
              ),
            ],
