...
class SettingsMenuStyle {
  ...
  SettingsMenuStyle({
    ...
    this.items,
        ...
        speed = speed ?? const Icon(Icons.speed, color: Colors.white, size: 20),
        selected = selected ?? const Icon(Icons.done, color: Colors.white, size: 20),
        chevron = chevron ?? const Icon(Icons.chevron_left, color: Colors.white);
