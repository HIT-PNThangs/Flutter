      ...
      child: GetBuilder<PodGetXVideoController>(
        ...
        builder: (_podCtr) {
          return MaterialIconButton(
            ...
            onPressed: () =>
                _podCtr.isFullScreen ? _podCtr.isWebPopupOverlayOpen = true : _podCtr.isWebPopupOverlayOpen = false,
                ...
                items: [
                  ...
                  PopupMenuItem(
                    ...
                    child: _bottomSheetTiles(
                      ...
                      subText:
                          _podCtr.isLooping ? _podCtr.podPlayerLabels.optionEnabled : _podCtr.podPlayerLabels.optionDisabled,
                    ),
                  ),
                  PopupMenuItem(
                    value: 'SPEED',
