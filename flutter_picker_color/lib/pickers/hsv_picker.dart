...
import '../color_picker/flutter_colorpicker.dart';
...
class _HSVColorPickerExampleState extends State<HSVColorPickerExample> {
  ...
  final textController = TextEditingController(
      text: '#2F19DB'); // The initial value can be provided directly to the controller.
        ...
        ExpansionTile(
          ...
          subtitle: Text(
            _labelTypes.isNotEmpty
                ? _labelTypes.map((e) => e.toString().split('.').last.toUpperCase()).toString()
                : '',
          ),
          children: [
            SwitchListTile(
