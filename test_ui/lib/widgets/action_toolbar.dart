...
import 'cicle_user_animations.dart';
...
class _ActionsToolbarState extends State<ActionsToolbar> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        _getSocialAction(icon: Icons.favorite, title: widget.numLikes, color: isLike ? Colors.red : Colors.grey[300]),
    ...
    return InkWell(
      ...
      child: Container(
          ...
          child: Column(children: [
            Icon(icon, size: isShare ? 25.0 : 35.0, color: color ?? Colors.grey.shade300),
            Padding(
  ...
  Widget _getPlusIcon() {
    return Positioned(
      bottom: 0,
      left: ((ActionsToolbar.ActionWidgetSize / 2) - (ActionsToolbar.PlusIconSize / 2)),
      child: Container(
        width: ActionsToolbar.PlusIconSize, // PlusIconSize = 20.0;
        height: ActionsToolbar.PlusIconSize, // PlusIconSize = 20.0;
        decoration: BoxDecoration(color: const Color.fromARGB(255, 255, 43, 84), borderRadius: BorderRadius.circular(15.0)),
        child: const Icon(
          Icons.add,
          color: Colors.white,
          size: 20.0,
  ...
  Widget _getProfilePicture(userPic) {
    return Positioned(
        ...
        child: Container(
            ...
            // ProfileImageSize = 50.0;
            decoration:
                BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(ActionsToolbar.ProfileImageSize / 2)),
        ...
        child: Column(children: [
          Container(
              ...
              decoration: BoxDecoration(
                  gradient: musicGradient, borderRadius: BorderRadius.circular(ActionsToolbar.ProfileImageSize / 2)),
              child: ClipRRect(
                  borderRadius: BorderRadius.circular(10000.0),
                  child: CachedNetworkImage(
                    imageUrl: userPic,
