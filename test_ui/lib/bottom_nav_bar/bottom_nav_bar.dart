...
class BottomBar extends StatelessWidget {
  ...
  Widget get customCreateIcon => SizedBox(
      ...
      child: Stack(children: [
        Container(
            ...
            decoration:
                BoxDecoration(color: const Color.fromARGB(255, 250, 45, 108), borderRadius: BorderRadius.circular(7.0))),
        Container(
            margin: const EdgeInsets.only(right: 10.0),
            width: CreateButtonWidth,
            decoration:
                BoxDecoration(color: const Color.fromARGB(255, 32, 211, 234), borderRadius: BorderRadius.circular(7.0))),
        Center(
            child: Container(
  ...
  Widget menuButton(String text, IconData icon, int index, BuildContext context) {
    return InkWell(
        onTap: () {
