...
class OutlineGradientButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final BorderRadius br =
        corners != null ? _fromCorners(corners!, strokeWidth) : _fromRadius(radius ?? Radius.zero, strokeWidth);
    return Material(
      ...
      child: InkWell(
        ...
        child: CustomPaint(
          ...
          child: Padding(padding: padding, child: SizedBox(width: width, height: height, child: child)),
        ),
      ),
    );
  }
