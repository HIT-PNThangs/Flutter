...
class NeumorphicCheckbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double selectedIntensity =
        (style.selectedIntensity ?? theme.intensity).abs().clamp(Neumorphic.MIN_INTENSITY, Neumorphic.MAX_INTENSITY);
    final double unselectedIntensity = style.unselectedIntensity.clamp(Neumorphic.MIN_INTENSITY, Neumorphic.MAX_INTENSITY);
