...
class _NeumorphicButtonState extends State<NeumorphicButton> {
  ...
  void updateInitialStyle() {
    ...
    initialStyle =
        widget.style ?? (appBarPresent ? theme.appBarTheme.buttonStyle : (theme.buttonStyle ?? const NeumorphicStyle()));
  ...
  double _getScale() {
    if (widget.pressed != null) {
      ...
      return pressed ? NeumorphicButton.PRESSED_SCALE : NeumorphicButton.UNPRESSED_SCALE;
    }
  }
}
