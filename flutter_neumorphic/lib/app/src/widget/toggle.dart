...
class NeumorphicToggle extends StatelessWidget {
          ...
          child: FractionallySizedBox(
            ...
            child: Neumorphic(
              style: NeumorphicStyle(
                boxShape: NeumorphicBoxShape.roundRect(style?.borderRadius ?? const BorderRadius.all(Radius.circular(12))),
              ),
              margin: padding,
              child: thumb,
            ),
  ...
  Widget _backgroundAtIndex(int index) {
    return Expanded(flex: 1, child: children[index].background ?? const SizedBox.expand());
  }

  Widget _foregroundAtIndex(int index) {
    Widget? child = (!displayForegroundOnlyIfSelected) || (displayForegroundOnlyIfSelected && selectedIndex == index)
  ...
  Widget _background(BuildContext context) {
    return Neumorphic(
      style: NeumorphicStyle(
          ...
          lightSource: style?.lightSource ?? NeumorphicTheme.currentTheme(context).lightSource),
