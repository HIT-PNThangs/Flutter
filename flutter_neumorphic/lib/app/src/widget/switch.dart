...
import '../widget/animation/animated_scale.dart' as animationScale;
...
class NeumorphicSwitch extends StatelessWidget {
  ...
  Color _getTrackColor(NeumorphicThemeData theme, bool enabled) {
    ...
    return value == true ? style.activeTrackColor ?? theme.accentColor : style.inactiveTrackColor ?? theme.baseColor;
  }

  Color _getThumbColor(NeumorphicThemeData theme) {
    Color? color = value == true ? style.activeThumbColor : style.inactiveThumbColor;
