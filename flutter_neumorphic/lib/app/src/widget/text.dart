...
import '../decoration/neumorphic_text_decorations.dart';
...
class NeumorphicText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final NeumorphicStyle style = (this.style ?? const NeumorphicStyle()).copyWithThemeIfNull(theme).applyDisableDepth();
...
class __NeumorphicTextState extends material.State<_NeumorphicText> {
  @override
  Widget build(BuildContext context) {
    final TextPainter _textPainter = TextPainter(textDirection: TextDirection.ltr, textAlign: widget.textAlign);
