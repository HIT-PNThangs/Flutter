            ...
            children: <Widget>[
              Expanded(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      backgroundColor: selectedConfiguratorIndex == 0 ? buttonActiveColor : buttonInnactiveColor,
                    ),
                    child: Text(
                      "Style",
                      style: TextStyle(
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedConfiguratorIndex == 1 ? buttonActiveColor : buttonInnactiveColor,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                    ),
                    child: Text(
                      "Element",
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      backgroundColor: selectedConfiguratorIndex == 2 ? buttonActiveColor : buttonInnactiveColor,
                    ),
                    child: Text(
                      "Child",
                      style: TextStyle(
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: boxShape.isRoundRect ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
                  boxShape = NeumorphicBoxShape.roundRect(BorderRadius.circular(cornerRadius));
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: boxShape.isBeveled ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
                  boxShape = NeumorphicBoxShape.beveled(BorderRadius.circular(cornerRadius));
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: boxShape.isCircle ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: boxShape.isStadium ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: boxShape.isCustomPath ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
                  boxShape = NeumorphicBoxShape.path(NeumorphicFlutterLogoPathProvider());
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: shape == NeumorphicShape.concave ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: shape == NeumorphicShape.convex ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                backgroundColor: shape == NeumorphicShape.flat ? buttonActiveColor : buttonInnactiveColor,
              ),
              onPressed: () {
                setState(() {
