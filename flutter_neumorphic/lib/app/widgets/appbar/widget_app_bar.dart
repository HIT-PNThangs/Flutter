...
import '../../src/theme/app_bar.dart';
import '../../src/theme/neumorphic_theme.dart';
import '../../src/widget/app_bar.dart';
import '../../src/widget/back_button.dart';
import '../../src/widget/button.dart';
import '../../src/widget/close_button.dart';
  ...
  Widget build(BuildContext context) {
    return NeumorphicTheme(
      ...
      theme: NeumorphicThemeData(
        ...
        appBarTheme: NeumorphicAppBarThemeData(
          buttonStyle:
              NeumorphicStyle(color: Colors.black54, boxShape: NeumorphicBoxShape.roundRect(BorderRadius.circular(12))),
