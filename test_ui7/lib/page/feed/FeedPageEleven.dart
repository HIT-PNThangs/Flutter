...
class FeedPageEleven extends StatefulWidget {
  const FeedPageEleven({super.key});

  @override
  _FeedState createState() => _FeedState();
}

class _FeedState extends State<FeedPageEleven> with SingleTickerProviderStateMixin {
  ...
  Widget _listItemContent() => Positioned(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(colors: [RED_LIGHT, RED]),
          ),
  ...
  Widget _listContainer() => ListView.builder(
  ...
  Widget _tabTitleItem(title, isCurrent) => Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: isCurrent
                ? [const BoxShadow(color: DARK_COLOR, offset: Offset(0.0, 2.0))]
                : null),
        child: Text(
          title,
          style: TextStyle(
