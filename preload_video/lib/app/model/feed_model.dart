...
class FeedModel extends Equatable {
  ...
  const FeedModel(this.id, this.width, this.height, this.image, this.duration, this.user, this.videos);
  ...
  FeedModel.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        videos = json['video_files'] != null ? (json['video_files'] as List).map((e) => VideoFile.fromJson(e)).toList() : [];
