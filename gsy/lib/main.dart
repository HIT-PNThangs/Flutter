...
import 'widget/align_demo_page.dart'
deferred as align_demo_page;
import 'widget/anim_bg_demo_page.dart'
deferred as anim_bg_demo_page;
import 'widget/anim_bubble_gum.dart'
deferred as anim_bubble_gum;
import 'widget/anim_button/anim_button_demo_page.dart'
deferred as anim_button_demo_page;
import 'widget/anim_juejin_logo_demo_page.dart'
deferred as anim_juejin_logo_demo_page;
import 'widget/anim_progress_img_demo_page.dart'
deferred as anim_progress_img_demo_page;
import 'widget/anim_scan_demo_page.dart'
deferred as anim_scan_demo_page;
import 'widget/anim_switch_layout_demo_page.dart'
deferred as anim_switch_layout_demo_page;
import 'widget/anim_text_demo_page.dart'
deferred as anim_text_demo_page;
import 'widget/anim_tip_demo_page.dart'
deferred as anim_tip_demo_page;
import 'widget/anima_demo_page.dart'
deferred as anima_demo_page;
import 'widget/anima_demo_page2.dart'
deferred as anima_demo_page2;
import 'widget/anima_demo_page4.dart'
deferred as anima_demo_page4;
import 'widget/anima_demo_page5.dart'
deferred as anima_demo_page5;
import 'widget/animation_container_demo_page.dart'
deferred as animation_container_demo_page;
import 'widget/arc_seek_bar_demo_page.dart'
deferred as arc_seek_bar_demo_page;
import 'widget/blur_demo_page.dart'
deferred as blur_demo_page;
import 'widget/book_page/book_page.dart'
deferred as book_page;
import 'widget/bottom_anim_nav_page.dart'
deferred as bottom_anim_nav_page;
import 'widget/bubble/bubble_demo_page.dart'
deferred as bubble_demo_page;
import 'widget/canvas_click_demo_page.dart'
deferred as canvas_click_demo_page;
import 'widget/card_3d_demo_page.dart'
deferred as card_3d_demo_page;
import 'widget/card_item_page.dart'
deferred as card_item_page;
import 'widget/card_perspective_demo_page.dart'
deferred as card_perspective_demo_page;
import 'widget/card_real_3d_demo_page.dart'
deferred as card_real_3d_demo_page;
import 'widget/chat_list_scroll_demo_page.dart'
deferred as chat_list_scroll_demo_page;
import 'widget/chat_list_scroll_demo_page_2.dart'
deferred as chat_list_scroll_demo_page_2;
import 'widget/clip_demo_page.dart'
deferred as clip_demo_page;
import 'widget/cloud/cloud_demo_page.dart'
deferred as cloud_demo_page;
import 'widget/color_progress_demo_page.dart'
deferred as color_progress_demo_page;
import 'widget/controller_demo_page.dart'
deferred as controller_demo_page;
import 'widget/custom_multi_render_demo_page.dart'
deferred as custom_multi_render_demo_page;
import 'widget/custom_pull/refrsh_demo_page3.dart'
deferred as refrsh_demo_page3;
import 'widget/custom_shader_path_demo_page.dart'
deferred as custom_shader_path_demo_page;
import 'widget/custom_sliver/scroll_header_demo_page.dart'
deferred as scroll_header_demo_page;
import 'widget/custom_viewport/custom_viewport_page.dart'
deferred as custom_viewport_page;
import 'widget/dash_3d_demo_page.dart'
deferred as dash_3d_demo_page;
import 'widget/drag_img_demo_page.dart'
deferred as drag_img_demo_page;
import 'widget/drop_select_menu/drop_select_demo_page.dart'
deferred as drop_select_demo_page;
import 'widget/floating_touch_demo_page.dart'
deferred as floating_touch_demo_page;
import 'widget/gradient_text_demo_page.dart'
deferred as gradient_text_demo_page;
import 'widget/honor_demo_page.dart'
deferred as honor_demo_page;
import 'widget/index_stack_drag_card_demo_page.dart'
deferred as index_stack_drag_card_demo_page;
import 'widget/index_stack_drag_card_demo_page2.dart'
deferred as index_stack_drag_card_demo_page2;
import 'widget/input_bottom_demo_page.dart'
deferred as input_bottom_demo_page;
import 'widget/juejin_3d_box_logo_demo_page.dart'
deferred as juejin_3d_box_logo_demo_page;
import 'widget/juejin_3d_logo_demo_page.dart'
deferred as juejin_3d_logo_demo_page;
import 'widget/keyboard_demo_page.dart'
deferred as keyboard_demo_page;
import 'widget/link_sliver/link_sliver_demo_page.dart'
deferred as link_sliver_demo_page;
import 'widget/list_anim/list_anim_demo_page.dart'
deferred as list_anim_demo_page;
import 'widget/list_anim_2/list_anim_demo_page.dart'
deferred as list_anim_demo_page2;
import 'widget/list_link_bottomsheet_demo_page.dart'
deferred as list_link_bottomsheet_demo_page;
import 'widget/matrix_custom_painter_page.dart'
deferred as matrix_custom_painter_page;
import 'widget/overflow_image_page.dart'
deferred as overflow_image_page;
import 'widget/particle/particle_page.dart'
deferred as particle_page;
import 'widget/png_shadow_demo_page.dart'
deferred as png_shadow_demo_page;
import 'widget/positioned_demo_page.dart'
deferred as positioned_demo_page;
import 'widget/refrsh_demo_page.dart'
deferred as refrsh_demo_page;
import 'widget/refrsh_demo_page2.dart'
deferred as refrsh_demo_page2;
import 'widget/rich_text_demo_page.dart'
deferred as rich_text_demo_page;
import 'widget/rich_text_demo_page2.dart'
deferred as rich_text_demo_page2;
import 'widget/route_demo_page.dart'
deferred as route_demo_page;
import 'widget/scroll_inner_content_demo_page.dart'
deferred as scroll_inner_content_demo_page;
import 'widget/scroll_listener_demo_page.dart'
deferred as scroll_listener_demo_page;
import 'widget/scroll_to_index_demo_page.dart'
deferred as scroll_to_index_demo_page;
import 'widget/scroll_to_index_demo_page2.dart'
deferred as scroll_to_index_demo_page2;
import 'widget/shader_canvas_demo_page.dart'
deferred as shader_canvas_demo_page;
import 'widget/silder_verify_page.dart'
deferred as silder_verify_page;
import 'widget/sliver_list_demo_page.dart'
deferred as sliver_list_demo_page;
import 'widget/sliver_stick_demo_page.dart'
deferred as sliver_stick_demo_page;
import 'widget/sliver_tab/sliver_tab_demo_page3.dart'
deferred as sliver_tab_demo_page3;
import 'widget/sliver_tab_demo_page.dart'
deferred as sliver_tab_demo_page;
import 'widget/sliver_tab_demo_page2.dart'
deferred as sliver_tab_demo_page2;
import 'widget/statusbar_demo_page.dart'
deferred as statusbar_demo_page;
import 'widget/stick/stick_demo_page.dart'
deferred as stick_demo_page;
import 'widget/stick/stick_demo_page2.dart'
deferred as stick_demo_page2;
import 'widget/stick_sliver_list_demo_page.dart'
deferred as stick_sliver_list_demo_page;
import 'widget/tag_demo_page.dart'
deferred as tag_demo_page;
import 'widget/text_line_height_demo_page.dart'
deferred as text_line_height_demo_page;
import 'widget/text_size_demo_page.dart'
deferred as text_size_demo_page;
import 'widget/tick_click_demo_page.dart'
deferred as tick_click_demo_page;
import 'widget/transform_canvas_demo_page.dart'
deferred as transform_canvas_demo_page;
import 'widget/transform_demo_page.dart'
deferred as transform_demo_page;
import 'widget/verification_code_input_demo_page.dart'
deferred as verification_code_input_demo_page;
import 'widget/verification_code_input_demo_page2.dart'
deferred as verification_code_input_demo_page2;
import 'widget/viewpager_demo_page.dart'
deferred as viewpager_demo_page;
import 'widget/vp_list_demo_page.dart'
deferred as vp_list_demo_page;
import 'widget/wrap_content_page.dart'
...
Map<String, WidgetBuilder> routers = {
  "文本输入框简单的 Controller": (context) {
    return ContainerAsyncRouterPage(controller_demo_page.loadLibrary(), (context) {
  ...
  "列表滑动监听": (context) {
    return ContainerAsyncRouterPage(scroll_listener_demo_page.loadLibrary(), (context) {
      return scroll_listener_demo_page.ScrollListenerDemoPage();
    });
  },
  "滑动到指定位置": (context) {
    return ContainerAsyncRouterPage(scroll_to_index_demo_page.loadLibrary(), (context) {
      return scroll_to_index_demo_page.ScrollToIndexDemoPage();
    });
  },
  "滑动到指定位置2": (context) {
    return ContainerAsyncRouterPage(scroll_to_index_demo_page2.loadLibrary(), (context) {
      return scroll_to_index_demo_page2.ScrollToIndexDemoPage2();
    });
  },
  "展示渐变带边框的文本": (context) {
    return ContainerAsyncRouterPage(gradient_text_demo_page.loadLibrary(), (context) {
      return gradient_text_demo_page.GradientTextDemoPage();
    });
  },
  "Transform 效果展示": (context) {
    return ContainerAsyncRouterPage(transform_demo_page.loadLibrary(), (context) {
      return transform_demo_page.TransformDemoPage();
    });
  },
  "计算另类文本行间距展示": (context) {
    return ContainerAsyncRouterPage(text_line_height_demo_page.loadLibrary(), (context) {
  ...
  "通过绝对定位布局": (context) {
    return ContainerAsyncRouterPage(positioned_demo_page.loadLibrary(), (context) {
  ...
  "滑动验证": (context) {
    return ContainerAsyncRouterPage(silder_verify_page.loadLibrary(), (context) {
  ...
  "状态栏颜色修改（仅 App）": (context) {
    return ContainerAsyncRouterPage(statusbar_demo_page.loadLibrary(), (context) {
      return statusbar_demo_page.StatusBarDemoPage();
    });
  },
  "键盘弹出与监听（仅 App）": (context) {
    return ContainerAsyncRouterPage(keyboard_demo_page.loadLibrary(), (context) {
  ...
  "全局悬浮按键效果": (context) {
    return ContainerAsyncRouterPage(floating_touch_demo_page.loadLibrary(), (context) {
      return floating_touch_demo_page.FloatingTouchDemoPage();
    });
  },
  "全局设置字体大小": (context) {
    return ContainerAsyncRouterPage(text_size_demo_page.loadLibrary(), (context) {
      return text_size_demo_page.TextSizeDemoPage();
    });
  },
  "旧版实现富文本": (context) {
    return ContainerAsyncRouterPage(rich_text_demo_page.loadLibrary(), (context) {
      return rich_text_demo_page.RichTextDemoPage();
    });
  },
  "官方实现富文本": (context) {
    return ContainerAsyncRouterPage(rich_text_demo_page2.loadLibrary(), (context) {
      return rich_text_demo_page2.RichTextDemoPage2();
    });
  },
  "第三方 viewpager 封装实现": (context) {
    return ContainerAsyncRouterPage(viewpager_demo_page.loadLibrary(), (context) {
      return viewpager_demo_page.ViewPagerDemoPage();
    });
  },
  "列表滑动过程控件停靠效果": (context) {
    return ContainerAsyncRouterPage(sliver_list_demo_page.loadLibrary(), (context) {
      return sliver_list_demo_page.SliverListDemoPage();
    });
  },
  "验证码输入框": (context) {
    return ContainerAsyncRouterPage(verification_code_input_demo_page.loadLibrary(), (context) {
      return verification_code_input_demo_page.VerificationCodeInputDemoPage();
    });
  },
  "验证码输入框2": (context) {
    return ContainerAsyncRouterPage(verification_code_input_demo_page2.loadLibrary(), (context) {
      return verification_code_input_demo_page2.VerificationCodeInputDemoPage2();
    });
  },
  "自定义布局展示效果": (context) {
    return ContainerAsyncRouterPage(custom_multi_render_demo_page.loadLibrary(), (context) {
  ...
  "列表滑动停靠效果2 （Stick": (context) {
    return ContainerAsyncRouterPage(sliver_stick_demo_page.loadLibrary(), (context) {
      return sliver_stick_demo_page.SliverStickListDemoPage();
    });
  },
  "键盘顶起展示（仅 App）": (context) {
    return ContainerAsyncRouterPage(input_bottom_demo_page.loadLibrary(), (context) {
  ...
  "控件动画变形效果": (context) {
    return ContainerAsyncRouterPage(animation_container_demo_page.loadLibrary(), (context) {
      return animation_container_demo_page.AnimationContainerDemoPage();
    });
  },
  "时钟动画绘制展示": (context) {
    return ContainerAsyncRouterPage(tick_click_demo_page.loadLibrary(), (context) {
  ...
  "列表滑动过程 item 停靠动画效果": (context) {
    return ContainerAsyncRouterPage(list_anim_demo_page.loadLibrary(), (context) {
      return list_anim_demo_page.ListAnimDemoPage();
    });
  },
  "列表滑动过程 item 停靠动画效果2": (context) {
    return ContainerAsyncRouterPage(list_anim_demo_page2.loadLibrary(), (context) {
      return list_anim_demo_page2.ListAnimDemoPage2();
    });
  },
  "下弹筛选展示效果": (context) {
    return ContainerAsyncRouterPage(drop_select_demo_page.loadLibrary(), (context) {
  ...
  "强大的自定义滑动与停靠结合展示": (context) {
    return ContainerAsyncRouterPage(scroll_header_demo_page.loadLibrary(), (context) {
      return scroll_header_demo_page.ScrollHeaderDemoPage();
    });
  },
  "自定义列表内sliver渲染顺序": (context) {
    return ContainerAsyncRouterPage(custom_viewport_page.loadLibrary(), (context) {
      return custom_viewport_page.CustomViewportPage();
    });
  },
  "点击弹出动画提示": (context) {
    return ContainerAsyncRouterPage(anim_tip_demo_page.loadLibrary(), (context) {
      return anim_tip_demo_page.AnimTipDemoPage();
    });
  },
  "列表停靠展开+回到当前头部": (context) {
    return ContainerAsyncRouterPage(stick_sliver_list_demo_page.loadLibrary(), (context) {
      return stick_sliver_list_demo_page.StickSliverListDemoPage();
    });
  },
  "使用 overflow 处理图片": (context) {
    return ContainerAsyncRouterPage(overflow_image_page.loadLibrary(), (context) {
  ...
  "多列表+顶部Tab效果展示": (context) {
    return ContainerAsyncRouterPage(sliver_tab_demo_page.loadLibrary(), (context) {
      return sliver_tab_demo_page.SliverTabDemoPage();
    });
  },
  "多列表+顶部Tab效果展示2": (context) {
    return ContainerAsyncRouterPage(sliver_tab_demo_page2.loadLibrary(), (context) {
      return sliver_tab_demo_page2.SliverTabDemoPage2();
    });
  },
  "多列表+顶部Tab效果展示3": (context) {
    return ContainerAsyncRouterPage(sliver_tab_demo_page3.loadLibrary(), (context) {
  ...
  "手势效果": (context) {
    return ContainerAsyncRouterPage(matrix_custom_painter_page.loadLibrary(), (context) {
      return matrix_custom_painter_page.MatrixCustomPainterDemo();
    });
  },
  "一个有趣的底部跟随和停靠例子": (context) {
    return ContainerAsyncRouterPage(scroll_inner_content_demo_page.loadLibrary(), (context) {
      return scroll_inner_content_demo_page.ScrollInnerContentDemoPage();
    });
  },
  "一个有趣的圆形选择器": (context) {
    return ContainerAsyncRouterPage(bottom_anim_nav_page.loadLibrary(), (context) {
      return bottom_anim_nav_page.BottomAnimNavPage();
    });
  },
  "一个类似探探堆叠卡片例子": (context) {
    return ContainerAsyncRouterPage(index_stack_drag_card_demo_page.loadLibrary(), (context) {
      return index_stack_drag_card_demo_page.IndexStackDragCardDemoPage();
    });
  },
  "一个类似探探堆叠卡片例子2": (context) {
    return ContainerAsyncRouterPage(index_stack_drag_card_demo_page2.loadLibrary(), (context) {
      return index_stack_drag_card_demo_page2.IndexStackDragCardDemoPage2();
    });
  },
  "动画按键例子": (context) {
    return ContainerAsyncRouterPage(anim_button_demo_page.loadLibrary(), (context) {
      return anim_button_demo_page.AnimButtonDemoPage();
    });
  },
  "类似QQ发送图片的动画": (context) {
    return ContainerAsyncRouterPage(anim_progress_img_demo_page.loadLibrary(), (context) {
      return anim_progress_img_demo_page.AnimProgressImgDemoPage();
    });
  },
  "类似探探扫描的动画效果": (context) {
    return ContainerAsyncRouterPage(anim_scan_demo_page.loadLibrary(), (context) {
      return anim_scan_demo_page.AnimScanDemoPage();
    });
  },
  "圆弧形的 SeekBar（仅APP）": (context) {
    return ContainerAsyncRouterPage(arc_seek_bar_demo_page.loadLibrary(), (context) {
  ...
  "纯 Canvas 绘制闹钟": (context) {
    return ContainerAsyncRouterPage(canvas_click_demo_page.loadLibrary(), (context) {
      return canvas_click_demo_page.CanvasClickDemoPage();
    });
  },
  "类似 boss 直聘我的页面联动效果": (context) {
    return ContainerAsyncRouterPage(link_sliver_demo_page.loadLibrary(), (context) {
      return link_sliver_demo_page.LinkSliverDemoPage();
    });
  },
  "结合 Matrix 的拖拽": (context) {
    return ContainerAsyncRouterPage(drag_img_demo_page.loadLibrary(), (context) {
      return drag_img_demo_page.DragImgDemoPage();
    });
  },
  "彩色进度条": (context) {
    return ContainerAsyncRouterPage(color_progress_demo_page.loadLibrary(), (context) {
      return color_progress_demo_page.ColorProgressDemoPage();
    });
  },
  "第三方的动画字体": (context) {
    return ContainerAsyncRouterPage(anim_text_demo_page.loadLibrary(), (context) {
      return anim_text_demo_page.AnimTextDemoPage();
    });
  },
  "首尾添加数据不会抖动": (context) {
    return ContainerAsyncRouterPage(chat_list_scroll_demo_page.loadLibrary(), (context) {
      return chat_list_scroll_demo_page.ChatListScrollDemoPage();
    });
  },
  "首尾添加数据不会抖动2": (context) {
    return ContainerAsyncRouterPage(chat_list_scroll_demo_page_2.loadLibrary(), (context) {
  ...
  "控件动画切换效果": (context) {
    ...
    return ContainerAsyncRouterPage(anim_switch_layout_demo_page.loadLibrary(), (context) {
  ...
  "3D 透视卡片": (context) {
    ...
    return ContainerAsyncRouterPage(card_perspective_demo_page.loadLibrary(), (context) {
  ...
  "硬核 3D 卡片旋转": (context) {
    ...
    return ContainerAsyncRouterPage(card_real_3d_demo_page.loadLibrary(), (context) {
  ...
  "展示 canvas transform": (context) {
    ///对应文章解析 https://juejin.cn/post/7129239231473385503
    return ContainerAsyncRouterPage(transform_canvas_demo_page.loadLibrary(), (context) {
  ...
  "rive 掘金 logo": (context) {
    ...
    return ContainerAsyncRouterPage(anim_juejin_logo_demo_page.loadLibrary(), (context) {
      return anim_juejin_logo_demo_page.AnimJueJinLogoDemoPage();
    });
  },
  "掘金 3d logo": (context) {
    ///对应文章解析 https://juejin.cn/post/7129239231473385503
    return ContainerAsyncRouterPage(juejin_3d_logo_demo_page.loadLibrary(), (context) {
      return juejin_3d_logo_demo_page.JueJin3DLogoDemoPage();
    });
  },
  "掘金更 3d logo": (context) {
    ///对应文章解析 https://juejin.cn/post/7129239231473385503
    return ContainerAsyncRouterPage(juejin_3d_box_logo_demo_page.loadLibrary(), (context) {
      return juejin_3d_box_logo_demo_page.JueJin3DBoxLogoDemoPage();
    });
  },
  "png shadow": (context) {
    return ContainerAsyncRouterPage(png_shadow_demo_page.loadLibrary(), (context) {
      return png_shadow_demo_page.PngShadowDemoPage();
    });
  },
  "path 路径 png 效果": (context) {
    return ContainerAsyncRouterPage(custom_shader_path_demo_page.loadLibrary(), (context) {
      return custom_shader_path_demo_page.CustomShaderPathDemoPage();
    });
  },
  "列表联动 BottomSheet 效果": (context) {
    return ContainerAsyncRouterPage(list_link_bottomsheet_demo_page.loadLibrary(), (context) {
