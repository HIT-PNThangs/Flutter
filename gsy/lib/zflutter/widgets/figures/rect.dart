...
import '../../core/widgets/shape.dart';
...
class RectPathBuilder extends PathBuilder {
  ...
  bool shouldRebuildPath(covariant PathBuilder oldPathBuilder) {
    return !(oldPathBuilder is RectPathBuilder) || oldPathBuilder.height != height || oldPathBuilder.width != width;
  }
}
...
class PolygonPathBuilder extends PathBuilder {
  ...
  @override
  bool shouldRebuildPath(covariant PathBuilder oldPathBuilder) {
    return !(oldPathBuilder is PolygonPathBuilder) || oldPathBuilder.sides != sides || oldPathBuilder.radius != radius;
  }
}
