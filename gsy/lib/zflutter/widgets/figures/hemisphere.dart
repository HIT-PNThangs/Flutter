...
class _ZCylinderMiddle extends ZShapeBuilder {
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderZHemisphere renderObject) {
...
class _RenderZHemisphere extends RenderZShape {
  ...
  _RenderZHemisphere(
      {required PathBuilder pathBuilder, required double diameter, required double stroke, required Color color})
      : _diameter = diameter,
        super(pathBuilder: pathBuilder, stroke: stroke, color: color, fill: true);
