...
class ZVector {
  ...
  ZVector _rotateProperty(double angle, VectorAxis propA, VectorAxis propB) {
    ...
    return replaceAxisInMap({propA: a * cos - b * sin, propB: b * cos + a * sin});
  }
  ...
  ZVector applyMatrix4(vector.Matrix4 arg) {
    ...
    final v2 = z;
    return ZVector(
      argStorage[0] * v0 + argStorage[4] * v1 + argStorage[8] * v2 + argStorage[12],
      argStorage[1] * v0 + argStorage[5] * v1 + argStorage[9] * v2 + argStorage[13],
      argStorage[2] * v0 + argStorage[6] * v1 + argStorage[10] * v2 + argStorage[14],
    );
  }
}
