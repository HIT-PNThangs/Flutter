  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int index) {
          controller.relativeAnimateTo(0.3, duration: const Duration(milliseconds: 200), curve: Curves.easeIn);
        },
  ...
  Widget build(BuildContext context) {
    return !scrolled
        ...
        : AppBar(
            ...
            automaticallyImplyLeading: false,
            title: const Text('Latest near you'),
            leading: IconButton(
              onPressed: () async {
                await widget.controller.position.scrollController
                    .animateTo(0, duration: const Duration(milliseconds: 200), curve: Curves.easeIn);
                await widget.controller
                    .relativeAnimateTo(0.3, duration: const Duration(milliseconds: 200), curve: Curves.easeOut);
              },
        ...
        builder: (BuildContext context, Widget? child) {
          ...
          return TweenAnimationBuilder<double>(
              ...
              builder: (BuildContext context, double t, Widget? child) {
                ...
                final Color? shadow = ColorTween(begin: Colors.black26, end: Colors.black26.withOpacity(0)).transform(t);
