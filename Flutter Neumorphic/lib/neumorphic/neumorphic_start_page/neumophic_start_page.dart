...
import 'bottom_left_clipper.dart';
import 'bottom_left_clipper_bottom.dart';
import 'clip_shadow_path.dart';
import 'top_right_cipper_bottom.dart';
import 'top_right_clipper.dart';

class NeumorphicStartPage extends StatelessWidget {
  const NeumorphicStartPage({super.key});
    ...
    return Material(
      child: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: const Alignment(0, 30.5),
            child: ClipShadowPath(
              shadow: boxShadow,
          ...
          Align(
            alignment: const Alignment(0, 80.5),
            child: ClipShadowPath(
              shadow: boxShadow,
