...
import 'core/blurhash_widget.dart';
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text(
            ...
            style: GoogleFonts.josefinSans(
              textStyle: TextStyle(
                  color: color, fontSize: 130, height: .84, fontWeight: FontWeight.bold, decoration: TextDecoration.none),
            ),
          ),
        ),
      ],
            ...
            child: Text(
              ...
              style: GoogleFonts.josefinSans(
                  textStyle: const TextStyle(
                      color: Color(0xFFDDDDDD), fontSize: 45, fontWeight: FontWeight.bold, decoration: TextDecoration.none)),
            ),
          )
        ],
      );
