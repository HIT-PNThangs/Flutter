...
import '../asms/better_player_asms_audio_track.dart';
import '../asms/better_player_asms_data_holder.dart';
import '../asms/better_player_asms_subtitle.dart';
import '../asms/better_player_asms_track.dart';
import '../asms/better_player_asms_utils.dart';
...
import '../configuration/better_player_controls_configuration.dart';
import '../configuration/better_player_data_source.dart';
import '../configuration/better_player_data_source_type.dart';
import '../configuration/better_player_drm_type.dart';
...
import '../configuration/better_player_video_format.dart';
...
import '../subtitles/better_player_subtitles_source_type.dart';
...
class BetterPlayerController {
  ...
  Future _setupAsmsDataSource(BetterPlayerDataSource source) async {
    ...
    if (data != null) {
      final BetterPlayerAsmsDataHolder _response = (await BetterPlayerAsmsUtils.parse(data, betterPlayerDataSource!.url)) as BetterPlayerAsmsDataHolder;
  ...
  Future _loadAsmsSubtitlesSegments(Duration position) async {
    try {
      ...
      final Duration loadDurationEnd =
          Duration(milliseconds: position.inMilliseconds + 5 * (_betterPlayerSubtitlesSource?.asmsSegmentsTime ?? 5000));
